...
The semi-implicit method \cite{jkp-132-312,jkp-93-144} is often used to solve stochastic partial differential equations that arise when Monte-Carlo methods are used in quantum optics and in atom optics \cite{pra-58-4824}.  This is done as a method of lines, in which the spatial axes are discretised, often by spectral derivatives, to give a system of ordinary differential equations.  The semi-implicit formula is then used to integrate these.
