...
\begin{equation}
    \frac{\partial\psi}{\partial t} = -\del^2\psi + V\psi,
\end{equation}
...
\cite{2000-Trefethen-Spectral}, and the semi-implicit formula is
used to integrate these equations.

{\bf Relate Hilbert space expansions to methods of lines using sync wave packets.}
