...
$$i\hbar |DΨ(t)〉=H|Ψ(t)〉.$$
Here, $|Ψ〉$ denotes a ket-valued function of time, and $|Ψ(t)〉$ is the ket that this function evaluates to at time $t$.  The Hamiltonian $H$, a Hilbert space operator, acts on this ket, not on the function $|Ψ〉$.  Therefore it is written outside the ket.  This could be abbreviated to
$$i\hbar |DΨ〉=H|Ψ〉.$$
