...
The first attempt at this will compute the dynamics of a quartic oscillator, with Hamiltonian $$H=\hbar a^{2\dagger}a²$.  It will do so by the midpoint method, discretising the differential equation
$$Du(t)=f(t)$$
...
$$|ψ(z^{n+1})〉≈|ψ(z^{n-1})〉+{2τH\over i\hbar}|ψ(z^ⁿ)〉.$$
